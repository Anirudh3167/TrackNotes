...
function NotesItem({item, key} : any) {
    ...
    return (
        <Link className="text-lg flex flex-col items-start justify-center h-44 max-sm:h-36 text-white p-5 max-sm:p-3 px-8 gap-4 bg-default-100 rounded-lg max-w-full"
